...
params.augment_weights = [0.9,.10,.10,.10,.10]; % 15, [1,.5,.5] also succeed
params.augment_weights = params.augment_weights ./ sum(params.augment_weights);
% params.augment_weights = [0.8,.15,.15,.15,.15]./1.4; % 15, [1,.5,.5] also succeed
%fprintf('-- CHECKED gpu augment new version\n');
% GPU
