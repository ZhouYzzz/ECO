function feature_map = extract_rotated_features(image, pos, scales, features, gparams, extract_info, ang)
...
for sz_ind = 1:num_sizes
    ...
    for scale_ind = 1:num_scales
        img_samples{sz_ind}(:,:,:,scale_ind) = sample_rotated_patch(image, pos, img_sample_sz*scales(scale_ind), img_input_sz, gparams, ang);
    end
end
